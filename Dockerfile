...
LABEL description="Offical docker image for whiss Pylon service (Bun)"
LABEL org.opencontainers.image.source="https://github.com/kleberbaum/whiss"
LABEL maintainer="kleber@snek.at"
